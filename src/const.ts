...
/** Constant `A` for vector multiplication */
export const A: BigUint64Array = new BigUint64Array([
...
/** Constant `C` for round key calculation */
export const C: Uint8Array[] = [
    new Uint8Array([
